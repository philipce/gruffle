...
describe Gruffle::Trace do
  ...
  it 'can act as an array of points' do
    state_1 = Gruffle::State.new(workflow_name: 'Foo')
    trace = described_class.new
    ...
    state_2 = Gruffle::State.new(workflow_name: 'Foo')
  ...
  it 'can be compared against other traces for equality' do
    state = Gruffle::State.new(workflow_name: 'Foo')
  ...
  describe '.from_hash' do
    ...
    it 'recreates a trace object from the hash representation' do
      state_1 = FooState.new(workflow_name: 'Foo')
      state_2 = BarState.new(workflow_name: 'Bar')
  ...
  describe 'point in a trace' do
    let(:state) { Gruffle::State.new(workflow_name: 'Foo') }
